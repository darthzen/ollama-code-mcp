...
async def generate_code(
    instruction: str, language: str = "", context_file: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.generate_code(instruction, language, context_file, think)


@mcp.tool()
async def review_code(
    code: str = "", file_path: str = "", focus: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.review_code(code, file_path, focus, think)


@mcp.tool()
async def refactor_code(
    instruction: str, code: str = "", file_path: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.refactor_code(instruction, code, file_path, think)


@mcp.tool()
async def fix_code(
    code: str = "", file_path: str = "", error_message: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.fix_code(code, file_path, error_message, think)


@mcp.tool()
async def write_tests(
    code: str = "", file_path: str = "", framework: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.write_tests(code, file_path, framework, think)


@mcp.tool()
async def explain_code(code: str = "", file_path: str = "", think: bool = False) -> str:
    ...
    """
    return await service.explain_code(code, file_path, think)


@mcp.tool()
async def code_review_diff(
    diff: str = "", diff_file: str = "", context: str = "", think: bool = True
) -> str:
    ...
    """
    return await service.code_review_diff(diff, diff_file, context, think)
...
async def batch_refactor(
    ...
    return await service.batch_refactor(
        glob_pattern, instruction, root_dir, dry_run, think
    )
